...
#define P1_DTOUT      RCONST(2.214773875)  // 2.214773875
#define P1_TOL_FACTOR RCONST(1.0e4)   // 1.0e4
...
#define P2_TOL_FACTOR RCONST(1.0e2) // 1.0e3
...
//export C++ class:
  char filename[14];
  strncpy(filename, "cvDireDemo.out", 14);
